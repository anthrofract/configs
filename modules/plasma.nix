        ...
        (
          { config, ... }:
          {
            ...
            programs.plasma = {
              ...
              kscreenlocker.appearance.wallpaper = "${config.home.homeDirectory}/Pictures/wallpapers/1-gold-rush.png";
              session.sessionRestore.restoreOpenApplicationsOnLogin = "startWithEmptySession";

              workspace = {
                lookAndFeel = "org.kde.breezedark.desktop";
                wallpaper = "${config.home.homeDirectory}/Pictures/wallpapers/1-gold-rush.png";
              };
